                     ...
                     <div class="row">
                        <div class="col col-login mx-auto" style = "margin-top: 100px;">
                           <div class="text-center mb-6">
                              <img src="{{env('APP_URL')}}/imagini/logo_ut.png" class="h-7" alt="" style="width: 70%; height:70% !important">
                           </div>
                           <form class="card" action="{{ route('login') }}" method="post">
                              ...
                              <div class="card-body p-6">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="email_cd" placeholder="Email" value="{{ old('email_cd') }}">
                                    <span class="text-danger">@error('email_cd'){{ $message }}@enderror</span>
                                 </div>
                                 <div class="form-group">
